    ...
    <main className='min-h-screen p-6 flex items-center flex-col font-press'>
        <div className='formContainer bg-yellow-300 p-8 rounded-lg shadow-lg w-full max-w-md'>
            ...
            <form className='grid grid-cols-[2fr_1fr] gap-x-2'> 
                <input type='text' className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 placeholder:text-xs" placeholder='Pokemon Name Here'></input>
                <button className='bg-red-600 text-white py-2 px-2 rounded-lg font-medium hover:bg-red-700 transition'>Search</button>
            </form>
        </div>
