    ...
    return (
        ...
        <main className="min-h-screen p-6 flex items-center flex-col">
            ...
            <div className="formContainer bg-yellow-300 p-8 rounded-lg shadow-lg w-full max-w-md">
                <form className="grid grid-cols-[1fr_2fr] gap-y-2 items-center">
                    {/* Email */}
                    <label htmlFor="email" className="block text-black font-medium">Email: </label>
                    <input type="email" id="email" placeholder="Enter your email" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"></input>
                    
                    {/* Password */}
                    <label htmlFor="password" className="block text-black font-medium">Password: </label>
                    <input type="password" id="password" placeholder="Enter your password" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"></input>
